...
import { walletConnected, getVotingList, isFinishVote } from '../../hooks/aleo.js';
// @ts-ignore
import { encodeBs58, decodeBs58 } from '../../utils/index.js';
...
export default function AcquireNft() {
  ...
  const getList = async (prop: any) => {
    ...
    const ipfsUrls = prop.map(
      (_item: any) => _item.text ? `https://${_item.text}.ipfs.nftstorage.link/` : 'http://localhost:3001/'
    )
    try {
